...
class AnimateIconsAdapted extends StatefulWidget {
  /// Default constructor
  const AnimateIconsAdapted({
    super.key,
  ...
  @override
  State<AnimateIconsAdapted> createState() => _AnimateIconsAdaptedState();
}

class _AnimateIconsAdaptedState extends State<AnimateIconsAdapted>
